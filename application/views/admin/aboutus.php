    ...
    <div class="card">
        <div class="card-body">
            ...
            <tbody>
                ...
                <td><?php echo $v->list1 ?></td>
                </tr>
                <tr>
                <th scope="row">List 2</th>
                <td><?php echo $v->list2 ?></td>
                </tr>
                <tr>
                <th scope="row">List 3</th>
                <td><?php echo $v->list3 ?></td>
                </tr>
                <tr>
                ...
                <td>
                <a href="<?php echo base_url('Welcome/aboutus_edit/'.$v->id) ?>" class="btn btn-success btn-xs">Edit</a>
                </td>
                </tr>
            </tbody>
            <?php } ?>

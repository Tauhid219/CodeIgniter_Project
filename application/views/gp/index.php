...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <?php
    $this->load->view('gp/about');
    ?>
    <!-- End About Section -->

    <!-- ======= Clients Section ======= -->
    <?php
    $this->load->view('gp/clients');
    ?>
    <!-- End Clients Section -->

    <!-- ======= Features Section ======= -->
    <?php
    $this->load->view('gp/features');
    ?>
    <!-- End Features Section -->

    <!-- ======= Services Section ======= -->
    <?php
    $this->load->view('gp/services');
    ?>
    ...
    <!-- ======= Team Section ======= -->
    <?php
    $this->load->view('gp/team');
    ?>
    <!-- End Team Section -->

    <!-- ======= Contact Section ======= -->
    <?php
    $this->load->view('gp/contact');
    ?>
    <!-- End Contact Section -->
